'use client'; // ✅ Essencial: Torna client-side, permite useForm e useSearchParams

import { useRouter, useSearchParams } from 'next/navigation';
import { useForm } from 'react-hook-form'; // ✅ Agora OK, roda no client
import { z } from 'zod';
import { zodResolver } from '@hookform/resolvers/zod';
import { useEffect } from 'react'; // Removi Suspense daqui
...
export default function LoginFormContent() { // Nome exportado para import no pai
